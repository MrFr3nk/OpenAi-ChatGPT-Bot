...
🤖 𝗕𝗢𝗧 𝗜𝗡𝗙𝗢 𝗦𝗘𝗧𝗧𝗜𝗡𝗚𝗦
*/
global.OWNER_NAME = 'Mr Frank' // Owner Name
global.OWNER_NUMBER = ['263719747303'] //Owner Number
global.BOT_ADMINS = ['263719747303'] //Bot admins numbers Like a Sudo Numbers
...
mess = {
	owner: '*This Command is only For Owner, Mr Frank.*',
	need_text: '*Please say something🥺🫤*'
}
react = {
    ai_message : '🤖',
    ai_image : '🤖'
